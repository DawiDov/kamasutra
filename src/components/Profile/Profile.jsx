    ...
    <div className={classes.content}>
      ...
      <div className={classes.avatar}>
        ...
        <p>
          ...
          atque obcaecati voluptatum optio temporibus officia odit sit! Sint,
          excepturi? Aliquam harum sit amet officiis culpa praesentium totam
          fugiat sapiente expedita?
        </p>
      </div>
      <MyPostsContainer />
    </div>
